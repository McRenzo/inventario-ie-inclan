...
<head>
    ...
    <title>Restablecer Contraseña - Inventario Inclán</title>
            ...
            <div class="relative z-10 my-auto max-w-md space-y-6">
                <div class="inline-flex bg-blue-500/10 p-3 rounded-2xl backdrop-blur-md border border-blue-500/20 shadow-sm">
                    <svg class="w-6 h-6 text-blue-400" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M12 15v2m-6 4h12a2 2 0 00-2-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"/>
                    </svg>
                </div>
                <h1 class="text-4xl lg:text-5xl font-black tracking-tight leading-[1.15] text-white">
                    Protege tu cuenta institucional
                </h1>
                <p class="text-slate-300 text-base leading-relaxed font-medium opacity-90">
                    Establece una nueva contraseña segura para seguir gestionando y rastreando el inventario patrimonial en tiempo real.
                </p>
            </div>
        ...
        <div class="w-full lg:w-1/2 flex flex-col justify-between items-center p-8 lg:p-16 bg-white">
            ...
            <div class="my-auto w-full max-w-md space-y-7">
                ...
                <div class="text-center lg:text-left space-y-2">
                    <h2 class="text-3xl font-black text-slate-900 tracking-tight sm:text-4xl">Actualizar contraseña</h2>
                    <p class="text-sm text-slate-500 font-semibold">Ingresa tus credenciales y define tu nueva clave de acceso.</p>
                </div>

                <!-- Alertas de Error (Adaptadas al estilo previo) -->
                @if ($errors->any())
                ...
                <form method="POST" action="{{ route('password.store') }}" class="space-y-5">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative group">
                            ...
                            <input id="email" type="email" name="email" value="{{ old('email', $request->email) }}" required autofocus placeholder="correo@inclan.edu.pe" 
                    ...
                    <!-- Nueva Contraseña -->
                    <div class="space-y-2">
                        <label for="password" class="block text-[10px] font-black text-slate-400 uppercase tracking-widest">Nueva Contraseña</label>
                        <div class="relative group">
                            <span class="absolute inset-y-0 left-0 flex items-center pl-4 text-slate-400 group-focus-within:text-blue-600 transition-colors">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                    ...
                    <div class="space-y-2">
                        <label for="password_confirmation" class="block text-[10px] font-black text-slate-400 uppercase tracking-widest">Confirmar Contraseña</label>
                        <div class="relative group">
                            <span class="absolute inset-y-0 left-0 flex items-center pl-4 text-slate-400 group-focus-within:text-blue-600 transition-colors">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
