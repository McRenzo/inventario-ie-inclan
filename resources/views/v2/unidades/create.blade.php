...
<div class="mx-auto max-w-6xl space-y-6">
    ...
    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
            ...
            <p class="mt-1 text-sm text-slate-500">
                Registra un bien físico con código interno propio.
            </p>
        </div>
    ...
    <form
        method="POST"
        action="{{ route('v2.unidades.store') }}"
        class="space-y-6"
    >
        @csrf
        ...
        <div class="rounded-3xl border border-slate-200/70 bg-white p-6 shadow-sm">
            <div class="mb-5">
                ...
                <p class="mt-1 text-xs text-slate-400">
                    Selecciona la ficha general y registra sus identificadores.
                </p>
            </div>
                ...
                <div class="md:col-span-2">
                    ...
                    @if ($bienes->isEmpty())
                        <p class="mt-2 text-xs font-semibold text-amber-600">
                            Primero debes crear una ficha con tipo de control individual.
                        </p>
                    @endif
                </div>
        ...
        <div class="rounded-3xl border border-slate-200/70 bg-white p-6 shadow-sm">
            <div class="mb-5">
                ...
                <p class="mt-1 text-xs text-slate-400">
                    Completa esta sección solo cuando exista una persona responsable.
                </p>
            </div>
