...
<div class="mx-auto max-w-5xl space-y-6">
    ...
    <form
        method="POST"
        action="{{ route('v2.bienes.update', $bien) }}"
        class="space-y-6"
    >
        @csrf
        @method('PUT')
            ...
            <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                ...
                <div>
                    ...
                    >
                        <option
                            value="individual"
                            @selected(old('tipo_control', $bien->tipo_control) === 'individual')
                        >
                            Individual
                        </option>
                        ...
                        <option
                            value="lote"
                            @selected(old('tipo_control', $bien->tipo_control) === 'lote')
                        >
                            Lote
                        </option>
                        ...
                        <option
                            value="consumible"
                            @selected(old('tipo_control', $bien->tipo_control) === 'consumible')
                        >
                            Consumible
                        </option>
                    </select>
                    ...
                    <p class="mt-2 text-xs text-slate-400">
                        No podrá cambiarse si la ficha ya tiene unidades o lotes registrados.
                    </p>
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea
                        ...
                        rows="4"
                        class="w-full rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm outline-none transition focus:border-blue-500 focus:bg-white focus:ring-4 focus:ring-blue-500/10"
                    >{{ old('descripcion', $bien->descripcion) }}</textarea>
                </div>
            </div>
        </div>
            ...
            <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                ...
                <div>
                    ...
                    <input
                        type="text"
                        name="material"
                        value="{{ old('material', $bien->material) }}"
                        class="w-full rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm outline-none transition focus:border-blue-500 focus:bg-white focus:ring-4 focus:ring-blue-500/10"
                    >
                </div>
                ...
                <div>
                    ...
                    <input
                        type="text"
                        name="procedencia"
                        value="{{ old('procedencia', $bien->procedencia) }}"
                        class="w-full rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm outline-none transition focus:border-blue-500 focus:bg-white focus:ring-4 focus:ring-blue-500/10"
                    >
                </div>
                ...
                <div>
                    ...
                    <input
                        ...
                        value="{{ old('nivel_educativo', $bien->nivel_educativo) }}"
                        class="w-full rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm outline-none transition focus:border-blue-500 focus:bg-white focus:ring-4 focus:ring-blue-500/10"
                    >
                </div>
